...
//               </p>
//               <p>
//                 <span className="font-medium">Location:</span> {repair.location}
//               </p>
//             </div>
//             <div className="space-y-1 text-right">
//               <p>
//                 <span className="font-medium">Duration:</span> {repair.duration}
//               </p>
//               <p>
...
const AllRepairs = () => {
  ...
  const userTime = time || "Some time ago";
  const userLocation = location || "Some location";
  const userRepairType = repairType || "Unknown repair";
  // const userSkillSet = skillSet || "Unknown repair";
  const userDuration = duration || "N/A";
  const userPrice = price || "N/A";
  ...
  useEffect(() => {
    ...
    localStorage.setItem("repairs", JSON.stringify(updatedRepairs));
    setRepairs(updatedRepairs);
  }, [userName, userTime, userLocation, userRepairType, userDuration, userPrice, userStatus]);
        ...
        >
          ...
          <div className="flex justify-between flex-wrap gap-2 text-sm text-gray-700 ml-12">
            <div className="space-y-1">
              ...
              {/* <p><span className="font-medium">Skill Set:</span> {repair.skill}</p> */}
