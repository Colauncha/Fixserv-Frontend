      ...
      <div className="min-h-screen flex flex-col px-16 py-12">
        ...
        <div className="w-full max-w-6xl p-6 rounded-xl">
          <div className="flex flex-col lg:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-10 ml-2 md:ml-4">
                ...
                <p className="text-md text-gray-700 mb-4">
                  ...
                  gravida nulla, turpis nec non placerat viverra vehicula, hendrerit
                  amet, in in malesuada quis.
                </p>
            ...
            <div className="w-full lg:w-96 bg-white px-6 py-6 rounded-lg shadow-lg border border-gray-200">
              ...
              <div className="flex gap-2 mb-4">
                <button className="bg-[#ECF1FC] rounded-full px-3 py-1 text-sm">Unavailable</button>
                <button className="bg-[#A1B7F2] text-white rounded-full px-3 py-1 text-sm">Available</button>
              </div>

              <div>
                <h4 className="font-semibold text-xs mb-2 text-[#110000C2]">Business Hours</h4>
        ...
        <div className="mt-6 w-full max-w-4xl p-6">
          ...
          <p className="text-md space-y-2 text-[#000000]">
