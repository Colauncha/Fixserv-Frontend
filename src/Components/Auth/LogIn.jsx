    ...
    <div className="min-h-screen flex flex-col justify-center lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#A1B7F2] relative items-center justify-center p-8">
        ...
        <div className="relative z-10 text-center px-10">
          <h1 className="text-4xl lg:text-7xl font-bold mb-4 text-[#110000C2]">
            Welcome Back!
          </h1>
      ...
      <div className="flex flex-col items-center justify-center w-full lg:w-1/2 p-6 sm:p-10">
        ...
        <div className="flex flex-col items-start w-full max-w-sm">
          ...
          <h2 className="text-xl text-[#110000C2] font-semibold mb-4">Login</h2>
        </div>
            ...
            <button
              ...
              className={`flex items-center justify-center w-full h-10 rounded-2xl px-4 py-2 transition cursor-pointer shadow-md ${
                loading
                  ...
                  : 'bg-[#ECF1FC] hover:bg-[#A1B7F2] text-black'
              }`}
            >
              {loading ? (
                <svg
