...
const ClientDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30">
      ...
      {fundWalletModalOpen && (
        <FundWalletModal closeModal={() => setFundWalletModalOpen(false)} />
      )}
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 lg:gap-8">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <div className="flex items-center justify-center lg:justify-start gap-2 text-sm sm:text-base text-gray-600 mb-4">
                  ...
                  <span>
                    {client.deliveryAddress.country},{' '}
              ...
              <div className="w-full lg:w-80 xl:w-96">
                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                  ...
                  <div className="flex gap-3">
                    <button
                      className="flex-1 py-2 px-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl text-sm font-medium shadow-lg hover:shadow-xl hover:scale-105 transition-all"
                  ...
                  <span className="flex items-center gap-2 mb-4">
                    ...
                    <div className="relative group">
                      ...
                      <div className="absolute left-0 top-6 w-64 bg-gray-800 text-white text-xs rounded-lg p-3 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none">
                        These are the devices, gadgets, appliances, or items you
                        need repaired.
                      </div>
                    </div>
                  </span>
