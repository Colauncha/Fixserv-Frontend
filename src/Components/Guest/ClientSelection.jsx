            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 flex-1">
                <div className="relative group">
                  <div className="absolute -inset-2 -z-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full blur opacity-25 group-hover:opacity-40 transition duration-300"></div>
                  ...
                  <div>
                    ...
                    {businessHoursOpen && (
                      <div className="space-y-3 pl-6">
                        {Object.entries(artisan.businessHours).map(
                          ([day, hours]) => (
                            <div
                              key={day}
            ...
            <div className="lg:col-span-1">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  {artisan.skillSet.join(', ').toLowerCase()}. Based in{' '}
                  {artisan.location}, I provide high-quality services through{' '}
