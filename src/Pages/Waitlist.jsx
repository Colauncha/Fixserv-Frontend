...
const Waitlist = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "password") {
      ...
      if (!minLength.test(value) || !hasNumber.test(value) || !hasUpper.test(value) || !hasSpecial.test(value)) {
        setPasswordStrength("Weak");
      } else if (minLength.test(value) && (hasNumber.test(value) || hasUpper.test(value) || hasSpecial.test(value))) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePhone(form.phoneNumber)) {
      toast.error("Enter a valid Nigerian phone number (e.g. 08012345678 or +2348012345678)");
      setLoading(false);
    ...
    const validatePassword = (password) => {
      ...
      if (!hasUpper.test(password)) return "Password must contain at least one capital letter";
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#F5F5F5] flex flex-col items-center py-20 px-4">
        ...
        <div className="w-full max-w-5xl bg-[#2C4179] rounded-md py-16 px-6 text-center text-white">
          ...
          <p className="text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            ...
            Join our waitlist today and lock in early access before the official drop.
          </p>
          ...
          <div className="w-full max-w-3xl bg-white p-10 rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col">
                <label className="text-[#1F4C73] font-medium mb-1">First Name</label>
                <input
                  ref={firstNameRef}
                  type="text"
                  name="firstName"
                  ...
                  ${errors.firstName ? "border-red-500" : "border-gray-300 focus:border-[#1F4C73]"}`}
                />
              </div>


              <div className="flex flex-col">
                <label className="text-[#1F4C73] font-medium mb-1">Last Name (Surname)</label>
                <input
                  ref={lastNameRef}
                  type="text"
                  name="lastName"
                  ...
                  className={`border rounded-md px-4 py-2 focus:outline-none 
                  ${errors.lastName ? "border-red-500" : "border-gray-300 focus:border-[#1F4C73]"}`}
                />
              </div>


              <div className="flex flex-col md:col-span-2">
                <label className="text-[#1F4C73] font-medium mb-1">Address</label>
                <input
                  ref={addressRef}
                  type="text"
                  name="address"
                  ...
                  className={`border rounded-md px-4 py-2 focus:outline-none 
                  ${errors.address ? "border-red-500" : "border-gray-300 focus:border-[#1F4C73]"}`}
                />
              </div>
              ...
              <div className="flex flex-col md:col-span-2">
                ...
                <input
                  ...
                  className={`border rounded-md px-4 py-2 focus:outline-none 
                  ${errors.email ? "border-red-500" : "border-gray-300 focus:border-[#1F4C73]"}`}
                />
              </div>


              <div className="flex flex-col md:col-span-2 relative">
                <label className="text-[#1F4C73] font-medium mb-1">Password</label>
      ...
      ${errors.password ? "border-red-500" : "border-gray-300 focus:border-[#1F4C73]"}`}
                />
              ...
              <div className="flex flex-col md:col-span-2 relative">
                ...
                <input
                  ...
                  className={`border rounded-md px-4 py-2 focus:outline-none w-full
      ${errors.confirmPassword ? "border-red-500" : "border-gray-300 focus:border-[#1F4C73]"}`}
                />
                ...
                {form.confirmPassword && (
                  <p
                    className={`mt-1 text-sm ${passwordMatch ? "text-green-500" : "text-red-500"
                      }`}
                  >
              ...
              <div className="flex flex-col md:col-span-2">
                <label className="text-[#1F4C73] font-medium mb-1">Phone Number</label>
                <input
                  ref={phoneNumberRef}
                  type="tel"
                  name="phoneNumber"
                  ...
                  className={`border rounded-md px-4 py-2 focus:outline-none 
      ${errors.phoneNumber ? "border-red-500" : "border-gray-300 focus:border-[#1F4C73]"}`}
                />
              </div>
              ...
              <div className="flex flex-col md:col-span-2">
                <label className="text-[#1F4C73] font-medium mb-1">Which user are you?</label>
                <select
                  ref={userTypeRef}
                  name="userType"
                  value={form.userType}
                  ...
                  ${errors.userType ? "border-red-500" : "border-gray-300 focus:border-[#1F4C73]"}`}
                >
