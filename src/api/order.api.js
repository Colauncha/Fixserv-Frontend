...
/**
 * Get the total number of completed jobs for a specific artisan.
 *
 * GET /artisan/:artisanId/work-stats
 *
 * Example response:
 * {
 *   artisanId: "f4e1ea8c-b8f2-40a3-83b0-1e930cad7977",
 *   completedJobs: 42
 * }
 */
export const getArtisanWorkStats = async (artisanId) => {
