  ...
  return (
    <div className="w-full bg-[#F6F6F6] flex justify-center">
      <section className="w-full max-w-5xl mt-10 px-10 py-10 relative">
        ...
        {/* Skip */}
        <button className="absolute top-6 cursor-pointer right-6 text-sm border border-gray-300 px-3 py-1 rounded text-gray-600">
          Skip onboarding
        </button>
        ...
        <p className="text-center text-sm text-gray-600 max-w-md mx-auto mb-10">
          Manage artisans, users, transactions and all platform activities from one centralized dashboard. Let's get you started!
        </p>
        ...
        <div className="border border-[#656565] px-6 py-4 flex items-center justify-between">
          ...
          {/* Next button */}
          <button   onClick={() => navigate("/admin/admin-setup-two")} className="bg-[#3E83C4] text-white text-sm px-6 py-2 rounded cursor-pointer">
            Next
          </button>
        </div>
