...
/>
  ...
  <p className="mt-1 text-sm text-blue-800">
    A <span className="font-semibold">5%</span> platform service fee will be
    deducted from every completed booking.
  </p>
  ...
  {service.price && Number(service.price) > 0 && (
    <div className="mt-2 space-y-1 text-sm">
      ...
      <div className="flex justify-between text-red-600">
        ...
        <span>
          ₦{(Number(service.price) * 0.05).toLocaleString()}
        </span>
      </div>
      ...
      <div className="border-t pt-2 flex justify-between font-semibold text-green-700">
        ...
        <span>
          ₦{(Number(service.price) * 0.95).toLocaleString()}
        </span>
      </div>
    </div>
  )}
