...
//   servicePreferences:
//     updatedUser?.servicePreferences ??
...
//   setFormData((prev) => ({
//     ...prev,
//     servicePreferences: [...prev.servicePreferences, value],
//   }));
...
//   setFormData((prev) => ({
//     ...prev,
//     servicePreferences: prev.servicePreferences.filter((s) => s !== service),
//   }));
// };
...
//   {formData.servicePreferences.map((service, index) => (
//     <span
//       key={index}
//       className="bg-[#D3E4F4] text-[#3E83C4] text-xs px-3 py-1 rounded-full flex items-center gap-1"
//     >
//       {service}
//       <button
//         type="button"
//         onClick={() => handleRemoveService(service)}
//         className="text-[#3E83C4] font-bold ml-1"
//       >
//         ✕
//       </button>
//     </span>
