...
const extractUser = (payload) => {
  ...
  // if still wrapped (e.g. {success, data:{...}})
  if (u?.data?.user) return u.data.user;
  if (u?.data && (u.fullName === undefined && u.email === undefined)) return u.data;

  return u;
};

const getUpdatedUserFromResponse = (data) => {
...
const handleProfileUpdate = async () => {
  ...
  try {
    ...
    // ✅ IMPORTANT: DON'T PATCH /api/admin from client
    ...
    // ✅ update your auth context so UI updates immediately
