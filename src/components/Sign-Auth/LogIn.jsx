// workign perfectly but needs to handle the ui error handling
    ...
    try {
      ...
      if (status === 403 && apiData?.code === "EMAIL_NOT_VERIFIED") {
        ...
        navigate("/verification", {
          state: {
            email,
            notice: "Please verify your email to continue.",
          },
        });
    ...
    <section className="h-screen grid grid-cols-1 lg:grid-cols-[40%_60%]">
      ...
      <div className="flex items-center justify-center px-6 sm:px-10 lg:px-16 py-10 sm:py-14 lg:py-16">
        ...
        <div className="w-full max-w-xl">
          ...
          <p className="text-sm text-[#656565] text-center mt-2 mb-8">
            Enter your details to log in your Fixserv account
          </p>
          ...
          <form ref={formRef} className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between mb-12">
              ...
              <button type="button" onClick={() => navigate("/forget-password")} className="text-sm text-[#3E83C4] hover:underline cursor-pointer">
                Forgot password?
              </button>
            </div>
