...
//       const rawMessage =
//         data?.errors?.[0]?.message || data?.message || err?.message || "";
...
//       const token = payload?.BearerToken;
...
//           <div className="w-full mb-4 rounded-md overflow-hidden border border-[#D9D9D9] bg-black flex items-center justify-center gap-3 px-4 py-3">
...
//               {formData.password && (
//                 <p
//                   className={`text-xs mt-1 ${getPasswordStrength(formData.password).color}`}
//                 >
//                   {getPasswordStrength(formData.password).label}
//                 </p>
//               )}
