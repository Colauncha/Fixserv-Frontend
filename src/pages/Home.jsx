  ...
  return (
    <div className="w-full overflow-x-hidden">
      <section className="relative w-full h-[90vh] flex items-center justify-center mt-4">
        ...
        <motion.div
          className="relative z-10 text-center w-full px-8"
        ...
        >
          ...
          <motion.p
            variants={fadeUp}
            className="mt-6 text-xl md:text-2xl text-white max-w-4xl mx-auto"
          >
            Connecting skilled professionals with clients for fast, reliable
            service.
          </motion.p>
      ...
      >
        <motion.div variants={fadeUp} className="w-full text-center mb-12 px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
            How It Works
          </h2>
          <p className="mt-4 text-gray-500 text-lg max-w-5xl mx-auto">
            Getting the right help shouldn&apos;t be stressful. With Fixserv,
            finding trusted repairers and skilled workers is quick,
            transparent, and reliable. Here&apos;s how it works:
          </p>
        </motion.div>
        ...
        <div className="w-full px-2">
          ...
          <motion.div
            variants={fadeUp}
            className="how-it-works-pagination mt-8 flex justify-center w-full"
          />
        </div>
      </motion.section>
      ...
      <motion.section
        className="relative w-full flex items-center justify-center mt-4 mb-8 py-14"
      ...
      >
        ...
        <div className="relative z-10 text-center w-full px-6">
          ...
          <p className="mt-6 text-sm md:text-lg text-blue-100 max-w-4xl mx-auto">
            No more relying only on word of mouth. Grow your income, showcase
            your skills, and build your reputation online with every job you
            complete.
          </p>
          <div className="mt-10 flex items-center justify-center gap-4 flex-wrap">
            <motion.button
      ...
      >
        <motion.div variants={fadeUp} className="text-center mb-14">
          <p className="text-lg text-[#3E83C4] font-medium mb-4">Testimonial</p>
          ...
          <p className="mt-2 text-gray-500 max-w-xl mx-auto text-sm">
            Real stories from our users and professionals who trust Fixserv
            every day.
          </p>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <motion.div
              ...
              className="bg-[#3E83C4] rounded-xl p-7 text-white border border-white/10"
            >
              <div className="flex gap-1 mb-4">
                {[...Array(5)].map((_, i) => (
                  <motion.img
              ...
              <p className="text-lg leading-relaxed mb-8">
                “I used to struggle finding someone reliable to fix my laptop.
                With Fixserv, I was matched with a technician in less than 10
                minutes, and the repair was perfect. This platform saves me so
                much stress.”
              </p>
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-14">
                “Before Fixserv, I only got jobs through word of mouth. Now, I
                get steady customers every week. It’s helping me grow my
                business and build a reputation online.”
              </p>
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-14">
                “Fixserv has changed the way I find work. Before, I relied only
                on word of mouth. Now, customers come directly to me, and my
                reputation grows with every review.”
              </p>
